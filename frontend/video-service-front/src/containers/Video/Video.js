...
function mapDispatchToProps(dispatch) {
    return {
        fetchVideoInfo: videoId =>
            dispatch(actions.videoFetchInfo("info/one", { videoId: videoId })),
        ...
        uploadVideoComment: (videoId, userId, token, text) =>
            dispatch(
                actions.videoUploadComment({
                    videoId: videoId,
                    userId: userId,
                    token: token,
                    text: text,
        ...
        rateVideo: (videoId, userId, token, actionType) =>
            dispatch(
                actions.videoRate({
                    videoId: videoId,
                    userId: userId,
        ...
        notificationSend: (message, variant) =>
            dispatch(actions.notificationSend(message, variant)),
...
class Video extends Component {
    ...
    videoPlaylistSetVideo = async type => {
        ...
        const curVidPos = videos.findIndex(
            video => video._id === this.props.currentVideoId
        );
    ...
    showCurrentPlaylistModalToggle = () => {
        this.setState(prevState => {
            return {
                showCurrentPlaylistModal: !prevState.showCurrentPlaylistModal,
            };
        });
    };
        ...
        return (
            <Container>
                ...
                <VideoInfo
                    ...
                    avatarId={videoInfo.author.avatar}
