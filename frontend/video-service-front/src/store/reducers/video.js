...
const reducer = (state = initialState, action) => {
    switch (action.type) {
        case actionTypes.VIDEO_FETCH_INFO_START:
            return videoFetchInfoStart(state);
        case actionTypes.VIDEO_FETCH_INFO_FAILED:
            return videoFetchInfoFailed(state, action);
        case actionTypes.VIDEO_FETCH_INFO_SUCCESS:
            return videoFetchInfoSuccess(state, action);
        case actionTypes.VIDEO_FETCH_COMMENTS_START:
            return videoFetchCommentsStart(state, action);
        case actionTypes.VIDEO_FETCH_COMMENTS_FAILED:
            return videoFetchCommentsFailed(state, action);
        case actionTypes.VIDEO_FETCH_COMMENTS_SUCCESS:
            return videoFetchCommentsSuccess(state, action);
        case actionTypes.VIDEO_STREAM_START:
            return videoStreamStart(state, action);
        case actionTypes.VIDEO_UPLOAD_START:
            return videoUploadStart(state);
        case actionTypes.VIDEO_UPLOAD_FAILED:
            return videoUploadFailed(state, action);
        case actionTypes.VIDEO_UPLOAD_SUCCESS:
            return videoUploadSuccess(state, action);
        //case actionTypes.VIDEO_UPLOAD_COMMENT_START: return videoUploadCommentStart(state, action);
        case actionTypes.VIDEO_UPLOAD_COMMENT_FAILED:
            return videoUploadCommentFailed(state, action);
        case actionTypes.VIDEO_UPLOAD_COMMENT_SUCCESS:
            return videoUploadCommentSuccess(state, action);
        case actionTypes.VIDEO_RATE_START:
            return videoRateStart(state);
        case actionTypes.VIDEO_RATE_SUCCESS:
            return videoRateSuccess(state, action);
        case actionTypes.VIDEO_RATE_FAILED:
            return videoRateFailed(state, action);
        case actionTypes.VIDEO_ADD_VIEW_SUCCESS:
            return videoAddViewSuccess(state, action);
        case actionTypes.VIDEO_EDIT_SUCCESS:
            return videoEditSuccess(state, action);
        case actionTypes.VIDEO_EDIT_FAILED:
            return state;
        case actionTypes.VIDEO_DELETE_SUCCESS:
            return videoDeleteSuccess(state, action);
        case actionTypes.VIDEO_DELETE_FAILED:
            return state;
        default:
            return state;
    }
